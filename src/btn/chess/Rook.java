...
public class Rook extends Piece {
	...
	/*
	 * Checks whether a position is reachable for the Rook at its current position.
	 * @param board: Board that the Rook currently resides on
	 * @param newPos: Vector2i specifying the position to check to see if the Rook can reach
	...
	public boolean isMoveValid(Board board, Vector2i newPos) {
		...
		if ((xDisp == 0 && yDisp == 0) || (xDisp != 0 && yDisp != 0)) {
			return false;
		}
